...
zipF<-file.choose("data/raw/nyccitycouncildistricts_21b.zip") # lets you choose a file and save its file path in R (at least for windows)
outDir<-"C:\Users\waddes\Documents\GitHub\Pence.Parker.Project\data\raw" # Define the folder where the zip file should be unzipped to 
