...
ggplot() +
  ...
  geom_sf_label(data=cc_districts_sf, aes(label= CounDist))+
  geom_point(data = permits_sf_ny, size=permits_sf_ny$ClassANet, color=permits_sf_ny$PermitYear, alpha=0.5) +
    theme_void() +
