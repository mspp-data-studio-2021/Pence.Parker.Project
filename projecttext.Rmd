...
```{r}
HousingData<- read.csv("C:/Users/waddes/Documents/GitHub/Pence.Parker.Project/data/raw/HousingDB_post2010_inactive_included.csv")
councilmemberdata<- read.csv("C:/Users/waddes/Documents/GitHub/Pence.Parker.Project/data/raw/city.council.database.xlsx - data.csv", strip.white=TRUE)
```
...
```
```{r}
post_2013_permits_dropped_splits_years_fixed<-mutate(post_2013_permits_dropped_splits, PermitYear = lubridate::ymd(PermitYear, truncated = 2L))
```

```{r}
seq.Date(post_2013_councilmembers, start.date, end.date, by ="year", )
```
